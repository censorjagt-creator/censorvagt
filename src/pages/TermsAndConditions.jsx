    ...
    <div className="legal-container">
      ...
      <ul>
        ...
        <li>
          ...
          "Us" or "Our" in this Agreement) refers to CensorVagt, owned by Azlo Pro.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to CensorVagt, accessible from <a href="https://azlo.pro/da/" target="_blank" rel="noopener noreferrer">https://azlo.pro/da/</a>
        </li>
        <li>
      ...
      <h2>Subscription</h2>
      <p>
        When You subscribe to Our Service, You must provide Us with an email address that
        is accurate and current at all times. Failure to do so
        constitutes a breach of the Terms, which may result in immediate
        termination of Your subscription on Our Service.
      </p>
      <p>
        Since We only require your email for notifications, you do not need to create
        a traditional user account or password with Us. Your subscription is managed
        directly through Our payment provider, Stripe.
      </p>

      <h2>Payments</h2>
      <p>
        We use Stripe for payment processing. By making a purchase, you agree to
        be bound by Stripe's Services Agreement, available at
        https://stripe.com/us/legal. We are not responsible for the performance of
        Stripe.
      </p>

      <h2>Termination</h2>
      <p>
        We may terminate or suspend Your subscription immediately, without prior notice
      ...
      <p>
        ...
        You wish to terminate Your subscription, You may simply do so via Your Stripe
        customer portal at any time.
      </p>
      ...
      <p>
        ...
        amount actually paid by You through the Service in the past 12 months or 100 DKK
      ...
      <ul>
        <li>By email: <a href="mailto:kontakt@censorvagt.dk">kontakt@censorvagt.dk</a></li>
      </ul>
    </div>
  );
}
