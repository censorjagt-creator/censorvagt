...
function PrivacyPolicy() {
  return (
    <div className="legal-container">
      ...
      <ul>
        <li>
          <strong>Subscription</strong> refers to the recurring notification service
          provided to You via Our payment provider.
        </li>
        <li>
      ...
      <p>
        ...
        You. Personally identifiable information generally consists only of:
      </p>
      <ul>
        <li>Email address</li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>To manage Your Subscription:</strong> to manage Your registration as a
          subscriber to the Service. The Personal Data You provide enables the core
          functionality of sending You email notifications.
        </li>
        <li>
      ...
      <p>
        Our Service is hosted on Vercel. Vercel may collect Usage Data and other
        information about Your use of the Service. We encourage you to review
        Vercel's privacy policy.
      </p>
      <p>
        We use Stripe for payment processing. When you provide payment information
        to make a purchase, you are providing it directly to Stripe. We do not
        have access to your full payment information. We encourage you to review
